...
const TREASURES = [
  ...
  },
  {
    ...
    type: 'singings',
    script: { han: '', hanvan: '', viet: '' },
    desc_vi: 'Hò là loại hình dân ca công việc đặc trưng của vùng Nghệ Tĩnh, một phần của Ví và Giặm đã được UNESCO công nhận. Hò vang vọng trên các cánh đồng lúa, phản ánh sự thanh vản và quần chúng của người nông dân.',
